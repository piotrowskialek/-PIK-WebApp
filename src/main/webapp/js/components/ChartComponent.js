...
export default class ChartComponent extends React.Component {
    ...
    componentDidUpdate() {
        console.log("Updated")
        if (this.dataa === this.props.data && this.times === this.props.times && this.currency === this.props.currency) {
        ...
        if (typeof this.dataa !== 'undefined' && typeof this.times !== 'undefined' && typeof this.currency !== 'undefined') {
            console.log("will did props", {dataa : this.dataa, times : this.times, currency : this.currency});
            let chartCanvas = this.refs.chart;
            let myChart = new Chart(chartCanvas, {
                type: 'line',
                data: {
    ...
    render() {
        return (
            <div>
                ...
                <div>
                    Currency in chart: {this.props.currency}
                </div>
                <div>
